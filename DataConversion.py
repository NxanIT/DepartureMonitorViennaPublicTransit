...
def __get_meassured_ids(line_selected:str,station_selected):
    ...
    stop_IDs_U4 = [[4401,4436], [4403,4434], [4405,4432], [4407,4430], [4409,4428], [4411,4426], [4413,4424], [4437,4438], [4415,4422], [4417,4420], [4419,4418], [4421,4416], [4423,4414], [4425,4412], [4427,4410], [4429,4408], [4431,4406], [4433,4404], [4439,4440], [4435,4402]] #index 0,0 is HÃÂÃÂÃÂÃÂ¼tteldorf -> Heiligenstadt
...
def __get_departures_platform_mode(data:dict,number_of_monitors):
    ...
    if (len(unfiltered_departures)<=number_of_monitors):
        departures = [unfiltered_departures[key] for key in unfiltered_departures.keys()]
        platforms = [key for key in unfiltered_departures.keys()]
